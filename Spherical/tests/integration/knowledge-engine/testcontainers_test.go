...
func SetupTestContainers(t *testing.T) *TestContainerSetup {
	...
	pgContainer, err := postgres.Run(ctx,
		...
		postgres.WithInitScripts("../../../ops/dev/init-pgvector.sql"),
...
func (s *TestContainerSetup) RunMigrations(t *testing.T) {
	...
	migrationPath := "../../../libs/knowledge-engine/db/migrations/0001_init.sql"
...
func TestRedisConnection(t *testing.T) {
	...
	// Note: In actual test, we'd use go-redis/v9
...
func TestFullStackIntegration(t *testing.T) {
	...
	err = db.QueryRowContext(ctx, `
		INSERT INTO products (tenant_id, name, product_type, make, settings)
		VALUES ($1, 'Test Camry', 'vehicle', 'Toyota', '{}')
		RETURNING id
